      ...
      <div style={{display:"flex",height:"100vh",background:"#06070e",fontFamily:"'Exo 2',sans-serif",color:"#e2e8f0",overflow:"hidden",position:"relative"}}>
        ...
        <div style={{flex:1,overflow:"auto",padding:"28px 30px",position:"relative",zIndex:1}}>
          ...
          {activeNav==="dashboard"&&<div className="page">
            ...
            {/* Discord Widget — visible to all members on Dashboard */}
            {discordInviteLink && (
              <div style={{marginBottom:18}}>
                <a href={discordInviteLink} target="_blank" rel="noopener noreferrer"
                  ...
                  <div style={{width:48,height:48,flexShrink:0,background:"#5865f2",borderRadius:14,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 14px rgba(88,101,242,0.45)"}}>
          ...
          {activeNav==="settings"&&(
            <div className="page" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:18,maxWidth:900}}>
              ...
              {/* Discord Integration — Admin only in Settings */}
              {isAdmin&&(
              <div style={{background:"rgba(88,101,242,0.06)",border:"1px solid rgba(88,101,242,0.22)",borderRadius:18,padding:"22px"}}>
                ...
                <p style={{color:"#3d5070",fontSize:11.5,marginBottom:16,lineHeight:1.6}}>Connect a Discord webhook for auto-notifications. Set an invite link so members can join your Discord server — the widget will appear on the Dashboard for all members.</p>
                ...
                <button className="btn" onClick={()=>{setDiscordConnected(true);showToast("🎮 Discord connected!");}}
                ...
                <div style={{borderTop:"1px solid rgba(88,101,242,0.18)",paddingTop:16,marginTop:4}}>
                  <label style={{display:"block",color:"#3d5070",fontSize:10.5,fontWeight:700,marginBottom:10,textTransform:"uppercase",letterSpacing:"0.08em"}}>Dashboard Widget Settings <span style={{color:"#7289da",fontWeight:400,textTransform:"none",fontSize:10}}>(shown on Dashboard for all members)</span></label>
                  <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:14}}>
                    <div>
                      <label style={{display:"block",color:"#3d5070",fontSize:10,fontWeight:700,marginBottom:5,textTransform:"uppercase",letterSpacing:"0.07em"}}>Server Name <span style={{color:"#64748b",fontWeight:400,textTransform:"none",fontSize:10}}>(shown beside logo)</span></label>
                    ...
                    <button className="btn" onClick={async()=>{
                      ...
                      showToast("✅ Discord widget saved — visible on Dashboard!");
